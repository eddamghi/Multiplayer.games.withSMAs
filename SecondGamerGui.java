...
public class SecondGamerGui extends Application {
    private SecondGamer secondGamer;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        buttonSend.setOnAction(event -> {
            ...
            secondGamer.onGuiEvent(guiEvent);
    ...
    private void startContainer() throws StaleProxyException {
        ...
        AgentController client = container.createNewAgent("Youssef",
                "org.example.SecondGamer", new Object[]{this});
        client.start();
    }

    public void setAgentClient1(SecondGamer secondGamer) {
